...
<body>
<header ><img src="logo22.png" width ="210" height="220" > </h2> </header>
	<section class = "box1">
      <h2>
...
$sql = "INSERT INTO users ( id , fname , lname , password , email ) 
  VALUES ( NULL ,'$_POST[fname]','$_POST[lname]','$_POST[pass]','$_POST[email]')";

if (mysqli_query($conn,$sql)) {
   print("<h1>New record created successfully</h1>");
} else {
